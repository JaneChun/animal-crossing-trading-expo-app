	...
	return (
		<View style={styles.screen}>
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<Text style={styles.listItem}>• 소셜 로그인(본인 식별 및 부정가입 방지)</Text>
				...
				{/* 2. 처리하는 개인정보 항목 */}
				<Text style={styles.sectionTitle}>제2조 (처리하는 개인정보의 항목)</Text>
				<Text style={styles.paragraph}>
					회원가입, 로그인, 서비스 이용 과정에서 아래 개인정보를 수집합니다.
				</Text>
				<Text style={styles.listItem}>• 필수: 이메일, 소셜 ID(네이버·카카오)</Text>
				<Text style={styles.listItem}>• 선택: 프로필 사진</Text>

				{/* 3. 보유 및 파기 */}
				<Text style={styles.sectionTitle}>제3조 (개인정보의 보유 및 파기)</Text>
				<Text style={styles.paragraph}>
					1. 보유 기간: 회원 탈퇴 요청 시점부터 <Text style={styles.highlight}>60일</Text>
					간 보관 후 파기합니다.{'\n'}
					2. 파기 절차: 파기 대상 선정 → 내부 방침에 따라 DB에서 완전 삭제합니다.{'\n'}
					3. 파기 방법: 전자적 파일 형태는 복원이 불가능한 방법으로 영구 삭제합니다.
				</Text>
				...
				<Text style={styles.listItem}>• 제공목적: 본인 식별 및 서비스 연동</Text>
				<Text style={styles.listItem}>• 보유기간: 소셜 플랫폼 정책에 따름</Text>

				<Text style={styles.paragraph}>• Google Inc.(Google AdSense)</Text>
				<Text style={styles.listItem}>• 제공항목: 행태정보(익명화된 광고 지표)</Text>
				<Text style={styles.listItem}>• 제공목적: 맞춤형 광고 제공 및 수익 정산</Text>
				...
				<Text style={styles.paragraph}>
					이용자는 언제든지 개인정보 열람·정정·삭제·처리정지 등을 요청할 수 있으며, 회사는
					해당 요청을 받은 즉시 필요한 절차를 진행하고, 처리 완료 후 가능한 빠른 시일 내에
					결과를 통지합니다.
				</Text>
				...
				<Text style={styles.paragraph}>
					회사는 개인정보 처리에 관한 업무를 총괄하는 책임자를 지정하고 있습니다.
				</Text>
				...
				<Text style={styles.paragraph}>
					회사는 개인정보 보호법 및 관련 지침에 따라, 내부관리계획 수립·시행, 접근권한
					통제, 전송·저장 시 암호화, 정기적 보안 점검 등 합리적인 수준의
					관리적·기술적·물리적 조치를 취하고 있습니다.
				</Text>

				{/* 9. 처리방침 변경 고지 */}
				<Text style={styles.sectionTitle}>제9조 (개인정보 처리방침 변경 및 공지)</Text>
				<Text style={styles.paragraph}>
					본 방침은 법령·정책 변경 시 개정될 수 있으며, 변경된 방침은 업데이트 배포 시점에
					App Store의 업데이트 내역(릴리즈 노트)에서 확인할 수 있도록 안내합니다.
				</Text>
