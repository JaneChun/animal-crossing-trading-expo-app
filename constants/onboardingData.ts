...
export const ONBOARDING_DATA: OnboardingStep[] = [
	{
		step: 0,
		image: require('../assets/images/onboarding/post.png'), // 글 작성 스크린샷
		title: '원하는 아이템이 있다면 \n거래글을 올려보세요',
	...
	{
		step: 1,
		image: require('../assets/images/onboarding/comment.png'), // 댓글에 채팅하기 버튼 활성화 스크린샷
		title: '댓글이 달리면 \n채팅하기 버튼이 나타나요',
	...
	{
		step: 2,
		image: require('../assets/images/onboarding/chat.png'), // 채팅방 스크린샷
	...
	{
		step: 3,
		image: require('../assets/images/onboarding/market.png'), // 마켓 일러스트
		title: '이제 모동숲 마켓을 \n시작해보세요!',
